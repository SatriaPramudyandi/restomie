...
<head>
    ...
    <title>
        Restomie : Information Delivery Order Tel-U
    </title>
    ...
    <link rel="shortcut icon" href="Mieceh.png">
</head>
    ...
    <div class="container">
        <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    ...
                    <img src="logo.png" class="visible-xs"><span class="sr-only">Restomie - go to homepage</span>
                </a>
        ...
        <div class="same-height-row">
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Special for Univ Dian Nuswantoro Semarang</h3>
                    <p>Aplikasi ini di khususkan untuk informasi delivery makanan di Semarang.</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <p>Aplikasi ini akan memberikan informasi lengkap mengenai menu makanan di warung-warung area Semarang yang memiliki menu Mie Aceh</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
<div class="box text-center" data-animate="fadeInUp">
    <div class="container">
        <div class="col-md-12">
            <h3 class="text-uppercase"> Restomie bekerja sama dengan banyak warung. </h3>
...
<!-- /#content -->
 ...
 <div id="copyright">
    <div class="container">
        <div class="col-md-6">
            <p class="pull-left">© Restomie 2022</p>
        </div>
        <div class="col-md-6">
            <p class="pull-right">Alright Reserved by Restomie
            </p>
        </div>
    </div>
</div>
